...
contract FairPriceLaunch is OwnableBase {
    ...
    event IssuefLOTUS(address investor, uint256 amount);
    ...
    constructor(
        ...
        //fLOTUS is passed in as argument and this contract needs to be set as owner
        redeemableToken = fLOTUS(_redeemableToken);
        saleEnabled = false;
        redeemEnabled = false;
    }
    ...
    **/
    ...
    function removeInvestment(uint256 amountToRemove) public {
       ...
       /**
    @dev Claims the fLOTUS tokens equivalent to their contribution
     */
    function claimRedeemable() public {
        ...
        emit IssuefLOTUS(msg.sender, issueAmount);
    }
