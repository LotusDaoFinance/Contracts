...
contract FairPriceLaunch is OwnableBase {
    ...
    // The Non-transferable token used for sale, redeemable for Lotus
    public redeemableToken;
    ...
    constructor(
        ...
        //LOTUS is passed in as argument and this contract needs to be set as owner
    ...
    **/
    ...
    function removeInvestment(uint256 amountToRemove) public {
       ...
       /**
    @dev Claims the LOTUS tokens equivalent to their contribution
     */
    ...
    function withdrawInvestablePool() public onlyOwner {
        ...
        //LotusTreasury(fundsRedeemer).deposit(amount, investToken, amount.div(1e9));
    }
